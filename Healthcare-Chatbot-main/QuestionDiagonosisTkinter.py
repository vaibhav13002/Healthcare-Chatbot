...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Ankit Pandey", bg="RoyalBlue2", width = "650", height = "2", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Vaibhav Mishra", bg="RoyalBlue3", width = "650", height = "2", font=("Calibri", 13))
        self.lblTeam2.pack()
